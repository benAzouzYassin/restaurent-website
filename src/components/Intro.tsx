    ...
    return (
        <main className="flex overflow-hidden lg:pl-32 lg:pr-32 flex-col gap-0">
            ...
            <motion.div initial={{ opacity: 0, y: 75 }} animate={{ opacity: 1, y: 0 }} className="flex ml-auto mr-auto mt-8 gap-8">
                ...
                <button className="bg-black text-white py-3 px-6 rounded-xl font-sans font-semibold text-md hover:cursor-pointer z-10 hover:border-white   hover:border-[1px]" onClick={() => redirectTo("/menu")}>Order Now</button>
            </motion.div>
        </main >
    )
}
