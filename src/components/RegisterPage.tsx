    ...
    return <div className="flex w-full flex-row  h-[100vh]">
        ...
        <div className="flex flex-col bg-[#33a474] border-l-2 h-full   border-solid pt-56 pl-32  w-[45%] pr-32 ">
            ...
            <form className="flex flex-col gap-8 mt-5" onSubmit={handleSubmit(formSubmit)} autoComplete="off">
                ...
                < input placeholder="your phone number" type="tel" className="bg-[#33a474] font-semibold placeholder:font-normal border-2 shadow-lg border-gray-700 text-xl p-4 rounded-3xl focus-within:outline-0 placeholder:text-gray-800" {...register("phone", { required: true, minLength: 8, pattern: /^[0-9]+$/ })} />
