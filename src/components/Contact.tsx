...
function Contact() {
    ...
    return (
        <div className="lg:py-36  h-fit min-h-[900px] bg-[#f5e7c1] grid lg:grid-cols-2 gap-4 pt-20 bg-[url(/images/shape-1.png)] bg-no-repeat bg-left-bottom overflow-hidden pb-10 lg:pb-0" ref={ref}>
            ...
            <motion.div initial={{ display: "none" }} variants={{ "hidden": { opacity: 0, x: 150 }, "visible": { display: "block", opacity: 1, x: 0 } }} transition={{ duration: 0.3 }} animate={animation} className="lg:h-2/3 h-96 w-auto flex items-center justify-center z-50 "><iframe className="h-full rounded-2xl border-[10px] shadow-2xl border-white invert-[80%] grayscale-[20%] lg:h-[650px] lg:w-[650px] w-[90vw] ml-auto mr-auto" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4030.660975726073!2d10.481403848039463!3d36.69522688638198!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12fd50f782264bc3%3A0x48fdb192672e5303!2sRestaurant%20Karoui!5e0!3m2!1sen!2stn!4v1687983562402!5m2!1sen!2stn" width="600" height="450" loading="lazy"  ></iframe></motion.div >
            <img className=" absolute left-0 z-50 lg:block hidden" src="/images/shape-1.png" />
            <img className=" absolute right-0 z-20 lg:block hidden" src="/images/shape-2.png" />
